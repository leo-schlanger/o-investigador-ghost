...
const ArticlesList = () => {
  ...
  const getTypeBadge = (articleType) => {
    ...
    return (
      <span
        className={`px-2 py-1 text-xs font-medium rounded-full ${colorStyles[typeConfig.color] || 'bg-gray-100 text-gray-800'}`}
      >
        {typeConfig.label}
      </span>
    );
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-5 sm:p-6">
            ...
            <p className="text-gray-600 text-sm sm:text-base mb-4">
              Tem certeza que deseja excluir o artigo <strong>"{deleteConfirm.title}"</strong>? Esta
