...
import { Folder, FolderOpen, ChevronRight, ChevronDown, Plus, MoreVertical, Pencil, Trash2, Image as ImageIcon } from 'lucide-react';
...
const FolderTree = ({
    ...
    const handleDelete = (folderId, folderName) => {
        if (window.confirm(`Eliminar a pasta "${folderName}"? Os ficheiros serao movidos para a pasta pai.`)) {
