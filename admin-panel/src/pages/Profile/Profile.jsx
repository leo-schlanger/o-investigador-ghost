...
const Profile = () => {
    ...
    const handleAvatarChange = async (e) => {
        ...
        if (!allowedTypes.includes(file.type)) {
            setStatus({ type: 'error', message: 'Tipo de arquivo nao permitido. Use: JPG, PNG, GIF ou WebP' });
            return;
        }
        ...
        try {
            ...
            setStatus({ type: 'error', message: 'Erro ao carregar foto: ' + (err.response?.data?.error || err.message) });
            setAvatarPreview(user?.avatar || null);
        } finally {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            {status.message && (
                <div className={`p-3 sm:p-4 rounded mb-4 sm:mb-6 text-sm sm:text-base ${
            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6">
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        <h2 className="text-lg font-medium text-gray-900 border-b pb-2 mb-4">Informacoes Pessoais</h2>
                    ...
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 mb-4">Deixe em branco se nao quiser alterar sua senha.</p>
