                            ...
                            <div className="bg-blue-50 p-3 rounded text-sm text-blue-700 flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <ol className="list-decimal ml-4 mt-1 space-y-1">
                                        <li>Crie uma conta em <a href="https://www.brevo.com" target="_blank" rel="noopener noreferrer" className="underline">brevo.com</a></li>
                            ...
                            <label className="flex items-center gap-3 p-3 border rounded hover:bg-gray-50 cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Requer confirmacao por email antes de adicionar subscritores (recomendado para RGPD)
                                    </p>
                                </div>
                            </label>
                            <label className="flex items-center gap-3 p-3 border rounded hover:bg-gray-50 cursor-pointer">
