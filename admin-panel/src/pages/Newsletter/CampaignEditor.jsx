...
import {
    ChevronLeft, Save, Send, Clock, Eye, Mail, AlertCircle,
    Smartphone, Monitor, Settings, Image, FileText, Trash2,
    Plus, GripVertical, ChevronUp, ChevronDown, Type, List,
    Link as LinkIcon, Quote, Newspaper, Users, Calendar,
    Layout, Palette, TestTube
} from 'lucide-react';
import {
    getCampaign, createCampaign, updateCampaign,
    sendCampaign, scheduleCampaign, sendTestEmail,
    getLists
...
const BLOCK_TYPES = [
    ...
    { type: 'hero', label: 'Destaque Principal', icon: Newspaper, description: 'Noticia em destaque com imagem' },
    { type: 'section-title', label: 'Titulo de Seccao', icon: Type, description: 'Separador de seccoes' },
    { type: 'article', label: 'Artigo', icon: FileText, description: 'Noticia com imagem e resumo' },
    { type: 'article-list', label: 'Lista de Artigos', icon: List, description: 'Lista simples de links' },
...
const CampaignEditor = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            if (result.isMock) {
                alert('Modo de demonstracao: Para enviar campanhas reais, configure as credenciais do Brevo.');
            } else {
    ...
    const handleSendTest = async () => {
        ...
        try {
            ...
            if (result.isMock) {
                alert('Modo de demonstracao: Para enviar emails de teste, configure as credenciais do Brevo.');
            } else {
                ...
                return (
                    <div className="bg-gray-800 text-white p-4 rounded text-center text-sm">
                        ...
                        <p className="text-gray-400 mt-1 text-xs">
                            <a href="#" className="underline">{block.content.unsubscribeText || 'Cancelar subscricao'}</a>
                        </p>
                    </div>
                );
            ...
            <div className="space-y-4">
                ...
                {block.type === 'footer' && (
                    <>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Texto de Cancelamento</label>
                            <input
                                type="text"
                ...
                <div className="p-4 max-w-2xl mx-auto">
                    <div className="bg-white rounded-lg shadow p-6 space-y-6">
                        <div>
                            ...
                            <div className="mt-4">
                                <label className="block text-sm font-medium text-gray-700 mb-1">Responder Para</label>
                                <input
                                    type="email"
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {lists.map(list => (
                                    <label key={list.id} className="flex items-center gap-3 p-3 border rounded hover:bg-gray-50 cursor-pointer">
                                        <input
                                            type="checkbox"
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
                        <div className="p-4 border-b flex items-center justify-between">
                            ...
                            <button onClick={() => setShowBlockPicker(false)} className="text-gray-400 hover:text-gray-600">
                                ×
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                        ...
                        <div className="p-4 space-y-4">
                            ...
                            <p className="text-sm text-gray-500">
                                ...
                                A campanha sera enviada automaticamente na data e hora selecionadas.
                            </p>
