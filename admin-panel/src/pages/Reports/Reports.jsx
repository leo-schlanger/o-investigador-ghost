...
import { FileSpreadsheet, FileText, Download, Eye, Calendar, Users, BarChart2, RefreshCw } from 'lucide-react';
...
const Reports = () => {
    ...
    const fetchPreview = async () => {
        setLoading(true);
        try {
            const response = await api.get(`/api/reports/preview/${selectedType}?period=${selectedPeriod}`);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-xs ${selectedType === type.id ? 'text-white/70' : 'text-gray-500'}`}>
                                                {type.description}
                                            </p>
                                        </div>
                                    </button>
