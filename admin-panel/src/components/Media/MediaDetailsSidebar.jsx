...
import { X, Copy, Check, Trash2, FolderOpen, Image as ImageIcon, FileText, Calendar, HardDrive } from 'lucide-react';
import { updateMedia, getFolders } from '../../services/media';
import MediaTagInput from './MediaTagInput';

const MediaDetailsSidebar = ({
    media,
    onClose,
    onUpdate,
    onDelete
    ...
    const flatFolders = Array.isArray(folders) && folders[0]?.children !== undefined
