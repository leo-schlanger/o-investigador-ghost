...
const EmailPreview = ({ campaign, previewMode = 'desktop' }) => {
    ...
    const renderBlock = (block) => {
        switch (block.type) {
            case 'header':
                return (
                    <table width="100%" cellPadding="0" cellSpacing="0" style={{ backgroundColor: colors.brandDark }}>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td style={{ padding: padding, backgroundColor: '#ffffff' }}>
                                    ...
                                    <p style={{
                                        ...
                                        {block.content?.excerpt || 'Resumo da noticia principal que aparece em destaque na newsletter. Este texto deve captar a atencao do leitor e incentiva-lo a clicar para ler mais.'}
                                    </p>
            ...
            case 'section-title':
                return (
                    <table width="100%" cellPadding="0" cellSpacing="0">
                        <tbody>
                            <tr>
                                <td style={{ padding: `${padding} ${padding} 8px ${padding}`, backgroundColor: '#ffffff' }}>
                                    <table width="100%" cellPadding="0" cellSpacing="0">
                                        <tbody>
                                            <tr>
                                                <td style={{
                                ...
                                <td style={{
                                    ...
                                    <table width="100%" cellPadding="0" cellSpacing="0">
                                        <tbody>
                                            <tr>
                                                {/* Imagem */}
                                                <td width={isMobile ? '100' : '140'} valign="top" style={{ paddingRight: '16px' }}>
                                                    {block.content?.imageUrl ? (
                                                        <img
                                                            src={block.content.imageUrl}
                                                            alt=""
                                        ...
                                        <tbody>
                                            {(block.content?.articles || [
                                                ...
                                                <tr key={idx}>
                                                    <td style={{
                                                        padding: '12px 0',
                                                        borderBottom: idx < (block.content?.articles?.length || 3) - 1 ? `1px solid ${colors.border}` : 'none'
                                                    }}>
                                                        <table width="100%" cellPadding="0" cellSpacing="0">
                                                            <tbody>
                                                                <tr>
                            ...
                            <tr>
                                <td align="center" style={{ padding: padding, backgroundColor: '#ffffff' }}>
                                    <a
                                        ...
                                        style={{
                                            display: 'inline-block',
                                            backgroundColor: block.content?.style === 'outline' ? 'transparent' : colors.brand,
                        ...
                        <tbody>
                            <tr>
                                <td style={{ padding: `8px ${padding}`, backgroundColor: '#ffffff' }}>
                                    <hr style={{
                                        border: 'none',
                                        borderTop: block.content?.style === 'dashed'
                            ...
                            <tr>
                                <td style={{
                                    ...
                                    <p style={{
                                        ...
                                        {block.content?.copyright || `© ${new Date().getFullYear()} O Investigador. Todos os direitos reservados.`}
                                    </p>
                                    ...
                                    <p style={{
                                        ...
                                        <a href="#" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'underline' }}>
                                            Ver no browser
                                        </a>
                                        {' | '}
                                        <a href="#" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'underline' }}>
