            ...
            {loading ? (
              ...
              <div className="p-4 text-center text-gray-500">
                ...
                <p className="text-xs mt-1">
                  Revisoes sao criadas automaticamente ao editar o artigo
                </p>
              </div>
            ) : (
                  ...
                  <li key={revision.id}>
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-gray-400">por {revision.userName}</p>
                      </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-medium">Revisao #{previewRevision.revisionNumber}</h3>
                    <span
                      className={`px-2 py-1 rounded text-xs ${
                        previewRevision.status === 'published'
                          ? 'bg-green-100 text-green-700'
                          : previewRevision.status === 'scheduled'
                  ...
                  <p className="text-sm text-gray-600">
                    Editado por <strong>{previewRevision.userName}</strong> em{' '}
                    {formatDate(previewRevision.createdAt)}
                  </p>
                </div>
                ...
                {previewRevision.excerpt && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-700 italic">{previewRevision.excerpt}</p>
                  </div>
                )}
