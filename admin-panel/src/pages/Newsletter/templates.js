...
export const NEWSLETTER_TEMPLATES = [
    {
        ...
        blocks: [
            defaultHeader,
            {
                ...
                type: 'text',
                content: {
                    content: 'Bom dia! Aqui esta o resumo das principais noticias para comecar o seu dia bem informado.'
                }
            },
            {
                id: 'section-destaque',
            ...
            },
            {
                id: 'cta-1',
                type: 'button',
                content: { text: 'Ver Todas as Noticias', url: 'https://jornalinvestigador.pt', style: 'primary' }
            },
            defaultFooter
        ]
    },
    {
        ...
        blocks: [
            defaultHeader,
            {
                ...
                type: 'text',
                content: {
                    content: 'Esta semana trouxe desenvolvimentos importantes. Aqui esta o resumo do que precisa de saber.'
                }
            },
            {
...
export const BLOCK_TYPES = [
    { type: 'header', label: 'Cabecalho', icon: 'Layout', description: 'Logo e masthead do jornal', category: 'estrutura' },
    { type: 'hero', label: 'Destaque Principal', icon: 'Newspaper', description: 'Noticia em destaque com imagem grande', category: 'conteudo' },
    { type: 'section-title', label: 'Titulo de Seccao', icon: 'Type', description: 'Separador de seccoes', category: 'estrutura' },
    { type: 'article', label: 'Artigo', icon: 'FileText', description: 'Noticia com imagem e resumo', category: 'conteudo' },
    { type: 'article-list', label: 'Lista de Artigos', icon: 'List', description: 'Lista simples de links', category: 'conteudo' },
    { type: 'text', label: 'Texto', icon: 'AlignLeft', description: 'Paragrafo de texto livre', category: 'conteudo' },
    { type: 'quote', label: 'Citacao', icon: 'Quote', description: 'Citacao em destaque', category: 'conteudo' },
    { type: 'button', label: 'Botao CTA', icon: 'MousePointer', description: 'Botao de acao', category: 'conteudo' },
    { type: 'divider', label: 'Separador', icon: 'Minus', description: 'Linha divisoria', category: 'estrutura' },
    { type: 'footer', label: 'Rodape', icon: 'Layout', description: 'Rodape com links e copyright', category: 'estrutura' },
];
...
export const getDefaultBlockContent = (type) => {
    const defaults = {
        ...
        'article-list': { articles: [{ title: '', link: '' }, { title: '', link: '' }, { title: '', link: '' }] },
        text: { content: '' },
        quote: { text: '', author: '' },
        button: { text: 'Ler Mais', url: '', style: 'primary' },
        divider: { style: 'solid' },
        footer: { copyright: `© ${new Date().getFullYear()} O Investigador`, unsubscribeText: 'Cancelar subscricao' }
    };
