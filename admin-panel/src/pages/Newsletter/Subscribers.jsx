...
const Subscribers = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span
        className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${colors[statusInfo.color]}`}
      >
        <Icon size={12} />
        {statusInfo.label}
      </span>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <form onSubmit={handleAddSubscriber} className="p-4 space-y-4">
              {formError && (
                <div className="p-3 bg-red-50 text-red-600 rounded text-sm">{formError}</div>
              )}
              <div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <div className="p-4 space-y-4">
              <p className="text-sm text-gray-600">
                ...
                <code className="bg-gray-100 px-1 rounded">email, nome</code>
              </p>
