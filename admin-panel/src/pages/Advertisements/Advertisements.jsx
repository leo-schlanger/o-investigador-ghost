        ...
        <div className="max-w-4xl">
            ...
            <div className="bg-white shadow rounded-lg p-6 mb-6">
                ...
                <p className="text-sm text-gray-500 mb-6">
                    Configure cada posição de anúncio individualmente. Desative slots específicos sem desligar todos os anúncios.
                </p>
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between">
                                    <div className="flex items-start gap-3">
                                        <div className={`p-2 rounded-lg ${
                                            slotSettings.enabled && !isDisabled ? 'bg-brand/10 text-brand' : 'bg-gray-100 text-gray-400'
                                        }`}>
                                            <SlotIcon size={20} />
                                        </div>
                                        <div>
                                ...
                                <div className="mt-3 pl-11">
                                    <label className={`block text-xs font-medium mb-1 ${isDisabled ? 'text-gray-300' : 'text-gray-500'}`}>
                                        Ad Slot ID
                                    </label>
                                    <input
                                        type="text"
            ...
            <div className="bg-white shadow rounded-lg p-6 mb-6">
                ...
                <div className="border rounded-lg p-4 bg-gray-50">
                    <div className="max-w-3xl mx-auto space-y-4">
                        ...
                        <div className={`h-[90px] rounded flex items-center justify-center text-xs uppercase tracking-wider ${
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="w-[120px] space-y-4">
                                ...
                                <div className={`h-[100px] rounded flex items-center justify-center text-[10px] uppercase tracking-wider text-center px-1 ${
